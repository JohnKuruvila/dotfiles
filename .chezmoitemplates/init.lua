...
local config = {
        ...
        mappings = {
                ...
                n = {
                        ...
                        ["<leader>fml"] = { "<cmd>CellularAutomaton make_it_rain<cr>", desc = "Are you tired yet?" },
                        -- quick save
        ...
        plugins = {
                ...
                treesitter = { -- overrides `require("treesitter").setup(...)`
                        compilers = { "clang" },
                        ensure_installed = { "lua", "javascript", "typescript", "css", "scss", "html" },
                },
                -- use mason-lspconfig to configure LSP installations
                ["mason-lspconfig"] = { -- overrides `require("mason-lspconfig").setup(...)`
                        ensure_installed = { "eslint", "tsserver", "html" },
                },
                -- use mason-null-ls to configure Formatters/Linter installation for null-ls sources
                ["mason-null-ls"] = { -- overrides `require("mason-null-ls").setup(...)`
                        ensure_installed = { "prettier", "stylua", "cspell" },
                },
